...
* Emacs
  ...
  An Emacs companion package provides access to =verGo.sh= application search capabilities within Emacs.  This provides
  a uniform way to locate external tools in Emacs dot files in a platform agnostic way.

     https://github.com/richmit/mjr-vergo
